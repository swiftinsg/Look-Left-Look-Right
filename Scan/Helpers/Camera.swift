...
/*
(insert Apple Swift Playgrounds default project license here)
*/
...
final class Camera: NSObject, Sendable {
    ...
    private func initialize() {
        ...
        captureDevice = availableCaptureDevices.first { $0.position == .front } ?? AVCaptureDevice.default(for: .video)
